...
async function main() {
    ...
    await _config.setPlatform(uSDG.address)
    ...
    saveFrontendFiles(gameRee , uSDG ,market ,_config , usdt , _StableVault)
}

function saveFrontendFiles(nFT , uSDG , market ,_config , uSDT , _StableVault) {
...
let config = `
 ...
 export const uSDT_addr = "${uSDT.address}"
 export const StableVault_addr = "${_StableVault.address}"
`
